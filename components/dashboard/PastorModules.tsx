    ...
    <>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Ministerios */}
          <Link href="/ministerio" className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition cursor-pointer block">
            <div className="flex items-center mb-4">
            ...
            <h4 className="text-lg font-semibold text-gray-800 mb-2">Ministerios</h4>
            <p className="text-sm text-gray-600">Gestiona los ministerios de la iglesia</p>
          </Link>
